...
public class VentanaGlobalClientes extends JFrame {

    private final DatabaseConnector dbConnector;
    private JTable tablaDatos;
    private final String sqlQuery = "SELECT * FROM cliente_gb";
    private final String windowName = "Clientes";

    public VentanaGlobalClientes() {
