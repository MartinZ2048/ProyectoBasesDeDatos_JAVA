...
public class VentanaGlobalVentas extends JFrame {

    private final DatabaseConnector dbConnector;
    private JTable tablaDatos;
    private final String sqlQuery = "SELECT * FROM venta_gb";
    private final String windowName = "Ventas";

    public VentanaGlobalVentas() {
